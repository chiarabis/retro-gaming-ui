...
export const Heart = styled.div.attrs<ShapesAttrs>(
  ...
  12px 12px 0 0 ${({color}) => color}, 16px 12px 0 0 ${({color}) => color}, 20px 12px 0 0 ${({color}) => color}, 24px 12px 0 0 ${({color}) => color}, 
  28px 12px 0 0 ${({color}) => color}, 52px 12px 0 0 ${({color}) => color}, 56px 12px 0 0 ${({color}) => color}, 60px 12px 0 0 ${({color}) => color}, 
  64px 12px 0 0 ${({color}) => color}, 68px 12px 0 0 ${({color}) => color}, 72px 12px 0 0 ${({color}) => color}, 4px 16px 0 0 ${({color}) => color}, 
  8px 16px 0 0 ${({color}) => color}, 12px 16px 0 0 ${({color}) => color}, 16px 16px 0 0 ${({color}) => color}, 20px 16px 0 0 ${({color}) => color}, 
  24px 16px 0 0 ${({color}) => color}, 28px 16px 0 0 ${({color}) => color}, 32px 16px 0 0 ${({color}) => color}, 48px 16px 0 0 ${({color}) => color}, 
  52px 16px 0 0 ${({color}) => color}, 56px 16px 0 0 ${({color}) => color}, 60px 16px 0 0 ${({color}) => color}, 64px 16px 0 0 ${({color}) => color}, 
  68px 16px 0 0 ${({color}) => color}, 72px 16px 0 0 ${({color}) => color}, 76px 16px 0 0 ${({color}) => color}, 4px 20px 0 0 ${({color}) => color}, 
  8px 20px 0 0 ${({color}) => color}, 12px 20px 0 0 ${({color}) => color}, 16px 20px 0 0 ${({color}) => color}, 20px 20px 0 0 ${({color}) => color}, 
  24px 20px 0 0 ${({color}) => color}, 28px 20px 0 0 ${({color}) => color}, 32px 20px 0 0 ${({color}) => color}, 36px 20px 0 0 ${({color}) => color}, 
  44px 20px 0 0 ${({color}) => color}, 48px 20px 0 0 ${({color}) => color}, 52px 20px 0 0 ${({color}) => color}, 56px 20px 0 0 ${({color}) => color}, 
  60px 20px 0 0 ${({color}) => color}, 64px 20px 0 0 ${({color}) => color}, 68px 20px 0 0 ${({color}) => color}, 72px 20px 0 0 ${({color}) => color}, 
  76px 20px 0 0 ${({color}) => color}, 4px 24px 0 0 ${({color}) => color}, 8px 24px 0 0 ${({color}) => color}, 12px 24px 0 0 ${({color}) => color}, 
  16px 24px 0 0 ${({color}) => color}, 20px 24px 0 0 ${({color}) => color}, 24px 24px 0 0 ${({color}) => color}, 28px 24px 0 0 ${({color}) => color}, 
  32px 24px 0 0 ${({color}) => color}, 36px 24px 0 0 ${({color}) => color}, 40px 24px 0 0 ${({color}) => color}, 44px 24px 0 0 ${({color}) => color}, 
  48px 24px 0 0 ${({color}) => color}, 52px 24px 0 0 ${({color}) => color}, 56px 24px 0 0 ${({color}) => color}, 60px 24px 0 0 ${({color}) => color}, 
  64px 24px 0 0 ${({color}) => color}, 68px 24px 0 0 ${({color}) => color}, 72px 24px 0 0 ${({color}) => color}, 76px 24px 0 0 ${({color}) => color}, 
  4px 28px 0 0 ${({color}) => color}, 8px 28px 0 0 ${({color}) => color}, 12px 28px 0 0 ${({color}) => color}, 16px 28px 0 0 ${({color}) => color}, 
  20px 28px 0 0 ${({color}) => color}, 24px 28px 0 0 ${({color}) => color}, 28px 28px 0 0 ${({color}) => color}, 32px 28px 0 0 ${({color}) => color}, 
  36px 28px 0 0 ${({color}) => color}, 40px 28px 0 0 ${({color}) => color}, 44px 28px 0 0 ${({color}) => color}, 48px 28px 0 0 ${({color}) => color}, 
  52px 28px 0 0 ${({color}) => color}, 56px 28px 0 0 ${({color}) => color}, 60px 28px 0 0 ${({color}) => color}, 64px 28px 0 0 ${({color}) => color}, 
  68px 28px 0 0 ${({color}) => color}, 72px 28px 0 0 ${({color}) => color}, 76px 28px 0 0 ${({color}) => color}, 4px 32px 0 0 ${({color}) => color}, 
  8px 32px 0 0 ${({color}) => color}, 12px 32px 0 0 ${({color}) => color}, 16px 32px 0 0 ${({color}) => color}, 20px 32px 0 0 ${({color}) => color}, 
  ...
  72px 32px 0 0 ${({color}) => color}, 76px 32px 0 0 ${({color}) => color}, 4px 36px 0 0 ${({color}) => color}, 8px 36px 0 0 ${({color}) => color}, 
  12px 36px 0 0 ${({color}) => color}, 16px 36px 0 0 ${({color}) => color}, 20px 36px 0 0 ${({color}) => color}, 24px 36px 0 0 ${({color}) => color}, 
  28px 36px 0 0 ${({color}) => color}, 32px 36px 0 0 ${({color}) => color}, 36px 36px 0 0 ${({color}) => color}, 40px 36px 0 0 ${({color}) => color}, 
  44px 36px 0 0 ${({color}) => color}, 48px 36px 0 0 ${({color}) => color}, 52px 36px 0 0 ${({color}) => color}, 56px 36px 0 0 ${({color}) => color}, 
  60px 36px 0 0 ${({color}) => color}, 64px 36px 0 0 ${({color}) => color}, 68px 36px 0 0 ${({color}) => color}, 72px 36px 0 0 ${({color}) => color}, 
  76px 36px 0 0 ${({color}) => color}, 4px 40px 0 0 ${({color}) => color}, 8px 40px 0 0 ${({color}) => color}, 12px 40px 0 0 ${({color}) => color}, 
  16px 40px 0 0 ${({color}) => color}, 20px 40px 0 0 ${({color}) => color}, 24px 40px 0 0 ${({color}) => color}, 28px 40px 0 0 ${({color}) => color}, 
  32px 40px 0 0 ${({color}) => color}, 36px 40px 0 0 ${({color}) => color}, 40px 40px 0 0 ${({color}) => color}, 44px 40px 0 0 ${({color}) => color}, 
  48px 40px 0 0 ${({color}) => color}, 52px 40px 0 0 ${({color}) => color}, 56px 40px 0 0 ${({color}) => color}, 60px 40px 0 0 ${({color}) => color}, 
  64px 40px 0 0 ${({color}) => color}, 68px 40px 0 0 ${({color}) => color}, 72px 40px 0 0 ${({color}) => color}, 76px 40px 0 0 ${({color}) => color}, 
  8px 44px 0 0 ${({color}) => color}, 12px 44px 0 0 ${({color}) => color}, 16px 44px 0 0 ${({color}) => color}, 20px 44px 0 0 ${({color}) => color}, 
  24px 44px 0 0 ${({color}) => color}, 28px 44px 0 0 ${({color}) => color}, 32px 44px 0 0 ${({color}) => color}, 36px 44px 0 0 ${({color}) => color}, 
  40px 44px 0 0 ${({color}) => color}, 44px 44px 0 0 ${({color}) => color}, 48px 44px 0 0 ${({color}) => color}, 52px 44px 0 0 ${({color}) => color}, 
  56px 44px 0 0 ${({color}) => color}, 60px 44px 0 0 ${({color}) => color}, 64px 44px 0 0 ${({color}) => color}, 68px 44px 0 0 ${({color}) => color}, 
  72px 44px 0 0 ${({color}) => color}, 12px 48px 0 0 ${({color}) => color}, 16px 48px 0 0 ${({color}) => color}, 20px 48px 0 0 ${({color}) => color}, 
  ...
  64px 52px 0 0 ${({color}) => color}, 20px 56px 0 0 ${({color}) => color}, 24px 56px 0 0 ${({color}) => color}, 28px 56px 0 0 ${({color}) => color}, 
  32px 56px 0 0 ${({color}) => color}, 36px 56px 0 0 ${({color}) => color}, 40px 56px 0 0 ${({color}) => color}, 44px 56px 0 0 ${({color}) => color}, 
  48px 56px 0 0 ${({color}) => color}, 52px 56px 0 0 ${({color}) => color}, 56px 56px 0 0 ${({color}) => color}, 60px 56px 0 0 ${({color}) => color}, 
  ...
  56px 60px 0 0 ${({color}) => color}, 28px 64px 0 0 ${({color}) => color}, 32px 64px 0 0 ${({color}) => color}, 36px 64px 0 0 ${({color}) => color}, 
  ...
  48px 68px 0 0 ${({color}) => color}, 36px 72px 0 0 ${({color}) => color}, 40px 72px 0 0 ${({color}) => color}, 44px 72px 0 0 ${({color}) => color}, 
  40px 76px 0 0 ${({color}) => color};
